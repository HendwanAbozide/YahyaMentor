...
export function TestimonialCard({ testimonial, className }: TestimonialCardProps) {
    return (
        <Card className={`glass relative overflow-hidden border-white/20 bg-white/60 transition-all duration-300 hover:shadow-[0_0_25px_rgba(59,130,246,0.2)] hover:border-blue-500/30 w-full ${className}`}>
